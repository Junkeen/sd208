...
$gender = trim($_REQUEST['gender']); // Retrieve the selected gender

// Check fields are empty or not
if ($fname == '' || $lname == '' || $email == '' || $password == '' || $confirmpassword == '' || $gender == '') {
    $isValid = false;
...
// Insert records
if ($isValid) {
    $insertSQL = "INSERT INTO users (fname, lname, email, password, gender) VALUES (?, ?, ?, ?, ?)";
